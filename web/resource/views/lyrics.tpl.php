...
<div class="card card-block radius-0 p-0">
    <div class="card-title mb-0">
        <form method="POST" action="/lyrics/search" role="form" class="pt-3 pl-3 pr-3"
              data-url-results="/lyrics/results">
            <div class="form-row justify-content-end">
                <div class="col-sm-7 pb-3">
                    <div class="input-group">
                        ...
                        <label class="sr-only" for="query-packages">Package</label>
                ...
                <div class="col-sm-5 pb-3">
                    <div class="input-group">
                        ...
                        <input id="query" name="query" class="form-control"
                               placeholder="ex. Rammstein - Ohne Dich" required>
    ...
    <div class="table-responsive">
        <table id="lyrics-items" class="table table-hover mb-0">
            ...
            <tr hidden>
                <td class="text-left relative hover-show-btn">
                    ...
                    <div class="blockquote-footer" data-element="content"></div>
                    <div class="blockquote-footer">in <cite data-element="package"></cite></div>
                    <button type="button" class="btn btn-secondary"
                            data-element="fetchUrl" data-url="/lyrics/fetch"
...
<?php $this->view('modals/pkg-lyrics'); ?>
