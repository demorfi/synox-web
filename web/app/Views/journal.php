        ...
        <table id="lyric-items" class="table table-hover mb-0">
            ...
            <?php if ($this->journal->valid()) { ?>
                ...
                <?php foreach ($this->journal as $item) { ?>
                    <tr>
                        <td class="text-left"><?php print(htmlspecialchars($item['message'])); ?></td>
                        <td class="text-left"><?php print($item['date']); ?></td>
                    </tr>
                    <?php $this->total++; ?>
                <?php } ?>
            <?php } ?>
            ...
            <tr>
                ...
                <th class="text-right">
                    Total: <span data-element="total"><?php print($this->get('total', 0)); ?></span>
                </th>
            </tr>
            </tfoot>
        </table>
